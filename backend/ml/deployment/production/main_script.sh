ssh vingilot -t "
  ...
  if test -f /home/stud/tarasov/xtai_lab3/deployment/kubernates.yaml; then kubectl -n ${VINGILOT_USER} delete /home/stud/tarasov/xtai_lab3/deployment/kubernates.yaml --all; rm -rf /home/stud/tarasov/xtai_lab3/deployment; fi;
