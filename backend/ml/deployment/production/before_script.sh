...
ssh vingilot -t "mkdir -p ./xtai_lab3/deployment; if test -f .xtai_lab3/deployment/kubernates.yaml; then kubectl -n ${VINGILOT_USER} delete -f ./xtai_lab3/deployment/kubernates.yaml; fi; mkdir -p ./xtai_lab3/application; rm -rf .xtai_lab3/deployment/*; rm -rf .xtai_lab3/application/*;"
rsync -av backend/ml/deployment/production/* vingilot:./xtai_lab3/deployment
